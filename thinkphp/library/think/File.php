...
//                $savename = call_user_func_array($this->rule, [$this]);
                $savename =$savename.date('Y-m-d H:i:s',time());
                ...
                switch ($this->rule) {
                    ...
                    case 'date':
                        ...
                        break;
                    case 'ceshi':
                        $savename =date('Y-m-d H:i:s',time()).$savename;
                        break;
                    default:
...
//            $a=$savename;
//            $savename =date('Y-m-d H:i:s',time()).$a;
            $isMatched = preg_match('/([^\/.]*)\./', $savename, $matches);
